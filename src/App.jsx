...
const INICIATIVAS_PRINCIPALES = [
  {
    ...
    enlaceDirectoWA: `https://whatsapp.com{encodeURIComponent("¡Hola DCUATES! Me interesa participar en el proyecto de La Bibliobici y Amigos.")}`
  },
  {
    id: "ecatepets",
    ...
    enlaceDirectoWA: `https://whatsapp.com{encodeURIComponent("¡Hola DCUATES! Quiero sumarme a la causa de Ecatepets para el bienestar animal.")}`
  },
  {
    id: "alianzas-tarjeta",
    ...
    enlaceDirectoWA: `https://whatsapp.com{encodeURIComponent("¡Hola DCUATES! Me interesa generar una alianza ganar-ganar con ustedes.")}`
  },
  {
    ...
    enlaceDirectoWA: `https://whatsapp.com{encodeURIComponent("¡Hola DCUATES! Deseo publicar mi negocio en la plataforma de publicidad comunitaria.")}`
  }
];
...
const NUEVOS_PROYECTOS_DATA = [
  {
    ...
    enlaceDirectoWA: `https://whatsapp.com{encodeURIComponent("¡Hola DCUATES! Me gustaría solicitar una asesoría personal o de negocios.")}`
  },
  {
    id: "bazares",
    ...
    enlaceDirectoWA: `https://whatsapp.com{encodeURIComponent("¡Hola DCUATES! Quiero obtener información para participar en los bazares y mercados.")}`
  },
  {
    id: "noticias",
    ...
    enlaceDirectoWA: `https://whatsapp.com{encodeURIComponent("¡Hola DCUATES! Me interesa conocer la agenda cultural y las noticias del barrio.")}`
  },
  {
    id: "bienestar",
    categoria: "SALUD Y ESPARCIMIENTO",
    titulo: "Bienestar, Culture y Recreación",
    ...
    enlaceDirectoWA: `https://whatsapp.com{encodeURIComponent("¡Hola DCUATES! Solicito información sobre los talleres de bienestar, cultura y recreación.")}`
  }
];
    ...
    <div className="min-h-screen bg-[#1b4332] font-sans antialiased text-slate-900 selection:bg-emerald-500/30 relative">
      ...
      <section id="inicio" className="bg-[#e8f5e9] text-[#0f2d1e] py-12 px-4 md:py-16 border-b-4 border-[#0f2d1e]">
        <div className="mx-auto max-w-7xl grid gap-8 items-stretch lg:grid-cols-12">
          ...
          {/* COLUMNA DERECHA: Logo e Embed YouTube Reparado */}
          <div className="lg:col-span-4 flex flex-col items-center justify-between text-center space-y-4">
            ...
            {/* Ventana Multimedia con Dirección de Incrustación de YouTube Corregida */}
          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-2">
            {INICIATIVAS_PRINCIPALES.map((item) => (
              ...
              >
                ...
                {/* Enlace directo nativo HTML puro */}
                <a
      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between">
        ...
        <div className="hidden sm:flex items-center gap-2">
          ...
          <a href={REDES_SOCIALES.youtube} target="_blank" rel="noreferrer" className="flex h-9 w-9 items-center justify-center rounded-lg border border-emerald-800/20 bg-white text-emerald-800 transition-colors hover:bg-emerald-50" title="YouTube">
            <svg className="h-4 w-4 fill-current" viewBox="0 0 24 24" xmlns="http://w3.org">
              <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93c.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
            </svg>
          </a>
