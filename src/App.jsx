...
const TELEFONO_WA = "525520696627";
...
const INICIATIVAS_PRINCIPALES = [
 ...
 mensajeWA: "Hola DCUATES! Me interesa participar en el proyecto de La Bibliobici y Amigos. ¿Cómo puedo sumarme u obtener más información?"
 },
 {
 id: "ecatepets",
 icono: "🐾",
 ...
 mensajeWA: "Hola DCUATES! Quiero sumarme a la causa de Ecatepets. Me gustaría apoyar en el cuidado, adopción responsable o difusión de mascotas extraviadas."
 },
 {
 id: "alianzas-tarjeta",
 icono: "🤝",
 ...
 mensajeWA: "Hola DCUATES! Soy un emprendedor/organización y me interesa generar una Alianza Ganar-Ganar para hacer sinergia comunitaria."
 },
 {
 ...
 mensajeWA: "Hola DCUATES! Me interesa el proyecto de Publicidad Comunitaria para publicar mi negocio de forma gratuita."
 }
];
...
const NUEVOS_PROYECTOS_DATA = [
 ...
 mensajeWA: "Hola DCUATES! Solicito información sobre las Asesorías Personales y de Negocios para impulsar mis metas."
 },
 {
 id: "bazares",
 icono: "🎪",
 ...
 mensajeWA: "Hola DCUATES! Me interesa participar en los Bazares, Mercados y Tianguis para reactivar la economía local."
 },
 {
 id: "noticias",
 icono: "📰",
 ...
 mensajeWA: "Hola DCUATES! Quiero saber más sobre las Noticias y la Agenda Cultural de la comunidad."
 },
 {
 id: "bienestar",
 icono: "🌱",
 ...
 mensajeWA: "Hola DCUATES! Me gustaría preguntar por los talleres de Bienestar, Cultura y Recreación familiar."
 }
];
...
></iframe>
 ...
 <a
 key={opc.t}
 href={`https://whatsapp.com{TELEFONO_WA}&text=${encodeURIComponent(opc.m)}`}
 target="_blank"
 rel="noopener noreferrer"
