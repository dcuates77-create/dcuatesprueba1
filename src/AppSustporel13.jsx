...
// =========================================================================
// 1. CONFIGURACIÓN CENTRALIZADA DE VARIABLES, REDES Y HOJA DE CÁLCULO, MÁS MÚSICA
// =========================================================================
              ...
              <div className="lg:col-span-1 flex flex-col gap-2">
                ...
                >
                  ...
                  <ul className="space-y-1">
                    {RECOMENDACIONES_ESTRELLA.dcuates.map((r, i) => (
                      <li key={i}>
                  ...
                  <ul className="space-y-1">
                    {RECOMENDACIONES_ESTRELLA.comunidad.map((r, i) => (
                      <li key={i}>
                        <a href={r.enlace} target="_blank" rel="noopener noreferrer" className="underline underline-offset-2 hover:text-emerald-300">
                          {r.nombre}
                        </a>
