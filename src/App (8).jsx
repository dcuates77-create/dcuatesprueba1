...
const QUIENES_SOMOS = {
  ...
  objetivos: ["Difundir de forma gratuita a negocios, personas y causas de la zona", "Facilitar el acceso a libros, asesorías y bienestar para todas las familias", "Conectar a quien necesita ayuda con quien puede darla, sin barreras", "Fortalecer el tejido social a través de alianzas ganar-ganar"],
    ...
    <div className="min-h-screen bg-[#17472d] font-sans antialiased text-slate-900 selection:bg-emerald-500/30 relative pb-28 sm:pb-24">
      ...
      <section id="quienes-somos" className="scroll-mt-24 bg-[#17472d] text-white py-10 sm:py-16 px-4 border-b-4 border-[#0f2d1e]">
        <div className="mx-auto max-w-4xl text-center space-y-5">
          ...
          <p className="text-sm sm:text-lg text-emerald-50 leading-relaxed font-medium">
            {QUIENES_SOMOS.idea}
          </p>
          <div className="grid gap-3 sm:grid-cols-2 text-left max-w-2xl mx-auto pt-2">
          ...
          <p className="text-xs sm:text-sm text-emerald-200/80 italic leading-relaxed max-w-2xl mx-auto pt-2">
...
function ContenidoModalProyecto({ id, onCerrar }) {
  ...
  if (id === "ventas-con-causa") {
    return (
      <div className="space-y-4">
        ...
        <h3 className="text-xl sm:text-2xl font-black uppercase tracking-tight text-[#0f2d1e]">
  ...
  const galeria = GALERIAS_PROYECTOS[id];
  ...
  return (
    <div className="space-y-4">
      ...
      <h3 className="text-xl sm:text-2xl font-black uppercase tracking-tight text-[#0f2d1e] -mt-2">
        {proyecto.titulo}
      </h3>
